...
client = MQTTClient(client_id=mqtt_client_id,
                    ...
                    ssl=False)
def clientConnect(ADAFRUIT_USERNAME, ADAFRUIT_IO_PUB_FEEDNAME, ADAFRUIT_IO_SUB_FEEDNAME):
    try:
        client.connect()
...
clientConnect(ADAFRUIT_USERNAME, ADAFRUIT_IO_PUB_FEEDNAME, ADAFRUIT_IO_SUB_FEEDNAME)
